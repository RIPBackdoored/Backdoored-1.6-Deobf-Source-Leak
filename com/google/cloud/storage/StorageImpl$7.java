...
static final class StorageImpl$7 implements Function<Bucket, com.google.cloud.storage.Bucket> {
    ...
    @Override
    public com.google.cloud.storage.Bucket apply(final Bucket bucketPb) {
        return com.google.cloud.storage.Bucket.fromPb((Storage)this.val$serviceOptions.getService(), bucketPb);
    }
