...
public abstract class SheetsRequest<T> extends AbstractGoogleJsonClientRequest<T>
{
    ...
    public SheetsRequest(final Sheets abstractGoogleJsonClient, final String requestMethod, final String uriTemplate, final Object jsonContent, final Class<T> responseClass) {
    ...
    @Override
    public SheetsRequest<T> set(final String fieldName, final Object value) {
        return (SheetsRequest)super.set(fieldName, value);
    }
