...
public class Sheets extends AbstractGoogleJsonClient
{
    ...
    public class Spreadsheets
    {
        ...
        public class BatchUpdate extends SheetsRequest<BatchUpdateSpreadsheetResponse>
        {
            ...
            protected BatchUpdate(final Spreadsheets this$1, final String reference, final BatchUpdateSpreadsheetRequest batchUpdateSpreadsheetRequest) {
                this.this$1 = this$1;
                ...
                this.spreadsheetId = Preconditions.checkNotNull(reference, (Object)"Required parameter spreadsheetId must be specified.");
            }
        ...
        public class Get extends SheetsRequest<Spreadsheet>
        {
            ...
            protected Get(final Spreadsheets this$1, final String reference) {
                this.this$1 = this$1;
        ...
        public class GetByDataFilter extends SheetsRequest<Spreadsheet>
        {
            ...
            protected GetByDataFilter(final Spreadsheets this$1, final String reference, final GetSpreadsheetByDataFilterRequest getSpreadsheetByDataFilterRequest) {
                this.this$1 = this$1;
        ...
        public class DeveloperMetadata
        {
            ...
            public class Get extends SheetsRequest<com.google.api.services.sheets.v4.model.DeveloperMetadata>
            {
                ...
                protected Get(final DeveloperMetadata this$2, final String reference, final Integer reference2) {
                    this.this$2 = this$2;
                    ...
                    this.spreadsheetId = Preconditions.checkNotNull(reference, (Object)"Required parameter spreadsheetId must be specified.");
                    this.metadataId = Preconditions.checkNotNull(reference2, (Object)"Required parameter metadataId must be specified.");
                }
            ...
            public class Search extends SheetsRequest<SearchDeveloperMetadataResponse>
            {
                ...
                protected Search(final DeveloperMetadata this$2, final String reference, final SearchDeveloperMetadataRequest searchDeveloperMetadataRequest) {
                    this.this$2 = this$2;
        ...
        public class SheetsOperations
        {
            ...
            public class CopyTo extends SheetsRequest<SheetProperties>
            {
                ...
                protected CopyTo(final SheetsOperations this$2, final String reference, final Integer reference2, final CopySheetToAnotherSpreadsheetRequest copySheetToAnotherSpreadsheetRequest) {
                    this.this$2 = this$2;
                    ...
                    this.spreadsheetId = Preconditions.checkNotNull(reference, (Object)"Required parameter spreadsheetId must be specified.");
                    this.sheetId = Preconditions.checkNotNull(reference2, (Object)"Required parameter sheetId must be specified.");
                }
        ...
        public class Values
        {
            ...
            public class Append extends SheetsRequest<AppendValuesResponse>
            {
                ...
                protected Append(final Values this$2, final String reference, final String reference2, final ValueRange valueRange) {
                    this.this$2 = this$2;
                    super(this$2.this$1.this$0, "POST", "v4/spreadsheets/{spreadsheetId}/values/{range}:append", valueRange, AppendValuesResponse.class);
                    this.spreadsheetId = Preconditions.checkNotNull(reference, (Object)"Required parameter spreadsheetId must be specified.");
                    this.range = Preconditions.checkNotNull(reference2, (Object)"Required parameter range must be specified.");
                }
            ...
            public class BatchClear extends SheetsRequest<BatchClearValuesResponse>
            {
                ...
                protected BatchClear(final Values this$2, final String reference, final BatchClearValuesRequest batchClearValuesRequest) {
                    this.this$2 = this$2;
            ...
            public class BatchClearByDataFilter extends SheetsRequest<BatchClearValuesByDataFilterResponse>
            {
                ...
                protected BatchClearByDataFilter(final Values this$2, final String reference, final BatchClearValuesByDataFilterRequest batchClearValuesByDataFilterRequest) {
                    this.this$2 = this$2;
            ...
            public class BatchGet extends SheetsRequest<BatchGetValuesResponse>
            {
                ...
                protected BatchGet(final Values this$2, final String reference) {
                    this.this$2 = this$2;
            ...
            public class BatchGetByDataFilter extends SheetsRequest<BatchGetValuesByDataFilterResponse>
            {
                ...
                protected BatchGetByDataFilter(final Values this$2, final String reference, final BatchGetValuesByDataFilterRequest batchGetValuesByDataFilterRequest) {
                    this.this$2 = this$2;
            ...
            public class BatchUpdate extends SheetsRequest<BatchUpdateValuesResponse>
            {
                ...
                protected BatchUpdate(final Values this$2, final String reference, final BatchUpdateValuesRequest batchUpdateValuesRequest) {
                    this.this$2 = this$2;
            ...
            public class BatchUpdateByDataFilter extends SheetsRequest<BatchUpdateValuesByDataFilterResponse>
            {
                ...
                protected BatchUpdateByDataFilter(final Values this$2, final String reference, final BatchUpdateValuesByDataFilterRequest batchUpdateValuesByDataFilterRequest) {
                    this.this$2 = this$2;
            ...
            public class Clear extends SheetsRequest<ClearValuesResponse>
            {
                ...
                protected Clear(final Values this$2, final String reference, final String reference2, final ClearValuesRequest clearValuesRequest) {
                    this.this$2 = this$2;
            ...
            public class Get extends SheetsRequest<ValueRange>
            {
                ...
                protected Get(final Values this$2, final String reference, final String reference2) {
                    this.this$2 = this$2;
            ...
            public class Update extends SheetsRequest<UpdateValuesResponse>
            {
                ...
                protected Update(final Values this$2, final String reference, final String reference2, final ValueRange valueRange) {
                    this.this$2 = this$2;
    ...
    public static final class Builder extends AbstractGoogleJsonClient.Builder
    {
        public Builder(final HttpTransport transport, final JsonFactory jsonFactory, final HttpRequestInitializer httpRequestInitializer) {
            super(transport, jsonFactory, "https://sheets.googleapis.com/", "", httpRequestInitializer, false);
