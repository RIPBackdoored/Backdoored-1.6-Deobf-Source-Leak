...
public class GoogleIdToken extends IdToken
{
    ...
    public GoogleIdToken(final Header header, final Payload payload, final byte[] signatureBytes, final byte[] signedContentBytes) {
    ...
    public static class Payload extends IdToken.Payload
    {
        ...
        @Override
        public /* bridge */ IdToken.Payload set(final String fieldName, final Object value) {
