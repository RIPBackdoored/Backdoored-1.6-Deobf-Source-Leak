...
public class MapTooltip extends c
{
    ...
    public void a(final RenderTooltipEvent.PostText v) {
        ...
        if (!v.getStack().isEmpty() && v.getStack().getItem() instanceof ItemMap) {
            final MapData v2 = Items.FILLED_MAP.getMapData(v.getStack(), (World)MapTooltip.mc.world);
            if (v2 != null) {
                ...
                v3.draw();
                MapTooltip.mc.entityRenderer.getMapItemRenderer().renderMap(v2, false);
