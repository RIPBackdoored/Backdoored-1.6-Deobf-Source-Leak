...
public class p extends c
{
    ...
    public void bv() {
        try {
            final SoundManager v = (SoundManager)ObfuscationReflectionHelper.getPrivateValue((Class)SoundHandler.class, (Object)p.mc.getSoundHandler(), new String[] { "sndManager", "field_147694_f" });
            v.reloadSoundSystem();
        }
        catch (Exception v2) {
