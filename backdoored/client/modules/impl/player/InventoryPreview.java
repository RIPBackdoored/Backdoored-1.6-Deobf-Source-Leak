...
public class InventoryPreview extends c
{
    ...
    public InventoryPreview() {
        super();
        this.xu = new f.b.f.c("x", this, 2, 0, InventoryPreview.mc.displayWidth + 100);
        this.xh = new f.b.f.c("y", this, 2, 0, InventoryPreview.mc.displayHeight + 100);
    }
    ...
    public void bm() {
        ...
        final NonNullList<ItemStack> v3 = (NonNullList<ItemStack>)InventoryPreview.mc.player.inventory.mainInventory;
        ...
        for (int v4 = 9; v4 < v3.size(); ++v4) {
            ...
            if (!v5.isEmpty()) {
                InventoryPreview.mc.getRenderItem().renderItemAndEffectIntoGUI(v5, v6, v7);
                InventoryPreview.mc.getRenderItem().renderItemOverlays(g.fontRenderer, v5, v6, v7);
            }
        }
        RenderHelper.disableStandardItemLighting();
