...
public class InstantPortal extends c
{
    private f.b.f.c xe;
    private f.b.f.c xx;
    ...
    public void a(final n v) {
        if (this.bu() && (v.entityPlayer == null || v.entityPlayer.getUniqueID().equals(InstantPortal.mc.player.getUniqueID()))) {
            v.gm = this.xe.cp();
        }
    }
    ...
    public void a(final o v) {
        if (this.bu() && (v.entity == null || v.entity.getUniqueID().equals(InstantPortal.mc.player.getUniqueID()))) {
            v.gk = this.xx.cp();
        }
    }
}
