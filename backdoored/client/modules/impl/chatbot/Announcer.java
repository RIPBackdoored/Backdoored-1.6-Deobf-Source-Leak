...
public class Announcer extends c
{
    private f.b.f.c le;
    private Instant lx;
    private Vec3d vec3d;
    ...
    public void a(final bg$c v) {
        if (this.bu() && j.a(this.lx, Instant.now(), 60L) && this.le.cq()) {
            ...
            final int v2 = (int)Math.round(this.vec3d.distanceTo(Announcer.mc.player.getPositionVector()));
            if (v2 > 0) {
                this.z(this.ir.a(v2));
                this.lx = Instant.now();
            }
    ...
    public void a(final q v) {
        if (this.bu() && v.packet instanceof CPacketPlayerTryUseItemOnBlock && this.lo.cq()) {
            ...
            final ItemStack v3 = Announcer.mc.player.getHeldItem(v2.getHand());
    ...
    public void a(final BlockEvent.BreakEvent v) {
        if (this.bu() && v.getPlayer().equals((Object)Announcer.mc.player)) {
    ...
    private void z(String v) {
        ...
        if (this.bu()) {
            Announcer.mc.player.sendChatMessage(v + " thanks to Backdoored Client");
        }
    }
}
