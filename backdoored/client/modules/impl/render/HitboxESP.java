...
public class HitboxESP extends c
{
    private f.b.f.c ou;
    private f.b.f.c oh;
    ...
    public void a(final RenderWorldLastEvent v) {
        if (!this.bu() || HitboxESP.mc.world.playerEntities.size() <= 0) {
            return;
        }
    ...
    private void gj() {
        if (this.ou.cq()) {
            for (final EntityPlayer v : HitboxESP.mc.world.playerEntities) {
                if (f.b.q.x.c.g(v) && !v.getUniqueID().equals(HitboxESP.mc.player.getUniqueID())) {
