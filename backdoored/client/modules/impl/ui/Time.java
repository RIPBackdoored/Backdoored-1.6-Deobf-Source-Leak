...
public class Time extends c
{
    ...
    public Time() {
        ...
        this.vi = new f.b.f.c("Radius", this, 1, 0, Time.mc.displayWidth);
        this.vf = new f.b.f.c("x", this, 1, 0, (int)Math.round(Time.mc.displayWidth * 1.2));
        this.vq = new f.b.f.c("y", this, 1, 0, (int)Math.round(Time.mc.displayHeight * 1.2));
        this.vk = new f.b.f.c("Circle Accuracy", this, 1.0, 0.5, 2.0);
    }
    
    private static LocalTime n(final boolean v) {
        if (v) {
            final long v2 = Time.mc.world.getWorldTime() % 24000L;
