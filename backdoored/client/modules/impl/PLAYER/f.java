...
public class f extends c
{
    ...
    public void bh() {
        final List<TileEntity> v = (List<TileEntity>)f.mc.world.loadedTileEntityList;
    ...
    public void a(final ChunkEvent.Load v) {
        ...
        for (final ChunkPos v2 : f.mc.world.getPersistentChunks().keys()) {
            final Chunk v3 = f.mc.world.getChunk(v2.x, v2.z);
            ...
            if (f.mc.getCurrentServerData() != null) {
                v13 = f.mc.getCurrentServerData().serverIP;
            }
    ...
    private static /* synthetic */ boolean a(final TileEntity v) {
        return f.mc.player.getDistance((double)v.getPos().getX(), f.mc.player.posY, (double)v.getPos().getZ()) < 500.0;
    }
}
