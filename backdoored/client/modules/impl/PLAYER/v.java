...
public class v extends c
{
    ...
    public void bv() {
        ...
        // Original Bytecode:
        // 
        //     1: getfield        f/b/o/g/t/v.zk:Lf/b/f/c;
        //     4: ifnonnull       25
        //     7: aload_0         /* v */
        //     8: new             Lf/b/f/c;
        //    11: dup            
        ...
        //    22: putfield        f/b/o/g/t/v.zk:Lf/b/f/c;
        //    25: aload_0         /* v */
        //    26: getfield        f/b/o/g/t/v.zq:Lf/b/f/c;
        ...
        //   143: dup            
        //   144: getstatic       f/b/o/g/t/v.zi:Ljava/io/File;
        ...
        //   191: dup            
        //   192: aload_0         /* v */
        //   193: getfield        f/b/o/g/t/v.zk:Lf/b/f/c;
        ...
        //   217: putfield        f/b/o/g/t/v.zp:Ljavax/swing/Timer;
        //   220: aload_0         /* v */
        //   221: getfield        f/b/o/g/t/v.zp:Ljavax/swing/Timer;
        ...
        //   234: dup            
        //   235: aload_0         /* v */
        //   236: getfield        f/b/o/g/t/v.zk:Lf/b/f/c;
        ...
        //   255: putfield        f/b/o/g/t/v.zm:Ljavax/swing/Timer;
        //   258: aload_0         /* v */
        //   259: getfield        f/b/o/g/t/v.zm:Ljavax/swing/Timer;
        ...
        //   272: dup            
        //   273: aload_0         /* v */
        //   274: getfield        f/b/o/g/t/v.zk:Lf/b/f/c;
        ...
        //   292: putfield        f/b/o/g/t/v.zs:Ljavax/swing/Timer;
        //   295: goto            335
        //   298: astore_1        /* v */
        ...
        //   330: aload_0         /* v */
        //   331: iconst_0       
        //   332: invokevirtual   f/b/o/g/t/v.a:(Z)V
        //   335: return         
        //    StackMapTable: 00 0C FF 00 19 00 01 07 00 4C 00 00 FD 00 2E 07 00 34 01 0D 0D 0A 1C FD 00 2E 07 00 7E 01 F9 00 2A 25 F9 00 1A 42 07 00 2A 24
        //    Exceptions:
        //  Try           Handler
    ...
    private String gd() {
        ...
        for (int v2 = 0; v2 < 256; ++v2) {
            char v3;
            for (v3 = ' '; v3 == ' ' || !ChatAllowedCharacters.isAllowedCharacter(v3); v3 = f.b.o.g.t.v.zl[new Random().nextInt(f.b.o.g.t.v.zl.length)]) {}
            v.append(v3);
        }
        return v.toString();
    }
    ...
    private static /* synthetic */ void b(final ActionEvent v) {
        v.mc.player.sendChatMessage(StringUtils.repeat(v.zl[195], 256));
    }
    
    private /* synthetic */ void g(final ActionEvent v) {
        v.mc.player.sendChatMessage(this.gd());
    }
