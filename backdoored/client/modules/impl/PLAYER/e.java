...
public class e extends c
{
    ...
    private boolean gx() {
        if (e.mc.objectMouseOver == null || e.mc.objectMouseOver.sideHit == null) {
            this.blockPos = e.mc.player.getPosition().add(2, 0, 0);
        }
        else {
            this.blockPos = e.mc.objectMouseOver.getBlockPos().offset(e.mc.objectMouseOver.sideHit);
        }
        ...
        e.mc.player.inventory.currentItem = n.b(this.item);
        n.c(this.blockPos);
        if (this.gt()) {
    ...
    private boolean gz() {
        final int v = this.go();
        if (v != -1) {
            e.mc.player.inventory.currentItem = v;
            if (this.gt()) {
    ...
    private boolean gt() {
        final EnumFacing v = e.mc.player.getHorizontalFacing();
