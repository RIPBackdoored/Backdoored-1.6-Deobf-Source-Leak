...
public class AutoTrap extends c
{
    private f.b.f.c pm;
    private f.b.f.c ps;
    private Instant pe;
    ...
    public void bh() {
        ...
        final int v2 = AutoTrap.mc.player.inventory.currentItem;
        ...
        AutoTrap.mc.player.inventory.currentItem = v3;
        for (final EntityPlayer v4 : AutoTrap.mc.world.playerEntities) {
            if (f.b.q.x.c.g(v4)) {
                continue;
            }
            if (AutoTrap.mc.player.getDistance((Entity)v4) > this.pm.ck() || v4 == AutoTrap.mc.player || f.b.q.x.c.g(v4)) {
                continue;
            }
            ...
            for (final BlockPos v6 : array) {
                if (AutoTrap.mc.world.getBlockState(v6).getMaterial().isReplaceable() && AutoTrap.mc.world.getEntitiesWithinAABBExcludingEntity((Entity)null, new AxisAlignedBB(v6)).isEmpty()) {
                    n.c(v6);
                    this.pe = v;
                    return;
                }
        ...
        AutoTrap.mc.player.inventory.currentItem = v2;
    }
}
