...
public class StrengthPotDetect extends c
{
    ...
    public void bh() {
        ...
        for (final EntityPlayer v : StrengthPotDetect.mc.world.playerEntities) {
            if (v.equals((Object)StrengthPotDetect.mc.player)) {
                continue;
            }
