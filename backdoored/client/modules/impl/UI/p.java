...
public class p extends c
{
    ...
    public p() {
        super();
        this.uv = new f.b.f.c("x", this, 0, 0, p.mc.displayWidth + 50);
        this.ud = new f.b.f.c("y", this, 0, 0, p.mc.displayWidth + 50);
    ...
    public void bm() {
        ...
        for (final EntityPlayer v3 : p.mc.world.playerEntities) {
            if (!v3.equals((Object)p.mc.player)) {
