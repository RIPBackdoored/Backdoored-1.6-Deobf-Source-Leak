...
public class a extends c
{
    ...
    public void a(final MouseEvent v) {
        if (this.bu() && Mouse.isButtonDown(2) && a.mc.objectMouseOver.entityHit instanceof EntityPlayer) {
            this.entityPlayer = (EntityPlayer)a.mc.objectMouseOver.entityHit;
        }
    }
    ...
    public void bm() {
        if (this.entityPlayer != null) {
            try {
                a.mc.displayGuiScreen((GuiScreen)new GuiInventory(this.entityPlayer));
