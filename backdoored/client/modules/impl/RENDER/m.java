...
public class m extends c
{
    ...
    public void a(final RenderWorldLastEvent v) {
        ...
        if (this.zd.cq() && m.mc.player.dimension == -1) {
            return;
        }
        GL11.glEnable(3042);
        ...
        GL11.glEnable(2884);
        GL11.glDisable(2929);
        final double v2 = m.mc.getRenderManager().viewerPosX;
        final double v3 = m.mc.getRenderManager().viewerPosY;
        final double v4 = m.mc.getRenderManager().viewerPosZ;
        GL11.glPushMatrix();
        GL11.glTranslated(-v2, -v3, -v4);
        for (final TileEntity v5 : m.mc.world.loadedTileEntityList) {
