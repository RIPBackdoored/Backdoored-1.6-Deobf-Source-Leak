...
public class i extends c
{
    ...
    public i() {
        ...
        i.oy = new f.b.f.c("Whitelist", this, "Bedrock and Obby", new String[] { "All", "Only Bedrock", "Bedrock and Obby" });
    ...
    public void bh() {
        ...
        final Iterable<BlockPos> v = (Iterable<BlockPos>)BlockPos.getAllInBox(i.mc.player.getPosition().add(-this.ov.cp(), -this.ov.cp(), -this.ov.cp()), i.mc.player.getPosition().add(this.ov.cp(), this.ov.cp(), this.ov.cp()));
    ...
    public static boolean a(final BlockPos v, final boolean v) {
        ...
        final IBlockState[] v2 = { i.mc.world.getBlockState(v), i.mc.world.getBlockState(v.add(0, 1, 0)), i.mc.world.getBlockState(v.add(0, 2, 0)), i.mc.world.getBlockState(v.add(0, -1, 0)), i.mc.world.getBlockState(v.add(1, 0, 0)), i.mc.world.getBlockState(v.add(0, 0, 1)), i.mc.world.getBlockState(v.add(-1, 0, 0)), i.mc.world.getBlockState(v.add(0, 0, -1)) };
