...
public class e extends c
{
    ...
    private void c(final float v) {
        for (final EntityPlayer v2 : e.mc.world.playerEntities) {
            if (v2.equals((Object)e.mc.player)) {
                continue;
            }
            ...
            final double v5 = e.mc.getRenderManager().viewerPosX;
            final double v6 = e.mc.getRenderManager().viewerPosY;
            final double v7 = e.mc.getRenderManager().viewerPosZ;
            v4.offset(-v5, -v6, -v7);
