...
public class l extends c
{
    ...
    public void a(final RenderGameOverlayEvent v) {
        if (this.bu() && v.getType() == RenderGameOverlayEvent.ElementType.CROSSHAIRS) {
            v.setCanceled(true);
            final int v2 = new ScaledResolution(l.mc).getScaledWidth();
            final int v3 = new ScaledResolution(l.mc).getScaledHeight();
    ...
    private static void a(final float v, final int v, final int v, final float v) {
        final GameSettings v2 = l.mc.gameSettings;
        if (v2.thirdPersonView == 0) {
            if (l.mc.playerController.isSpectator() && l.mc.pointedEntity == null) {
                final RayTraceResult v3 = l.mc.objectMouseOver;
                if (v3 == null || v3.typeOfHit != RayTraceResult.Type.BLOCK) {
                    return;
                }
                final BlockPos v4 = v3.getBlockPos();
                final IBlockState v5 = l.mc.world.getBlockState(v4);
                if (!v5.getBlock().hasTileEntity(v5) || !(l.mc.world.getTileEntity(v4) instanceof IInventory)) {
                    return;
                }
            }
            if (!v2.hideGUI) {
                ...
                final Entity v6 = l.mc.getRenderViewEntity();
                if (v6 != null) {
