...
public class v extends c
{
    ...
    public void a(final ItemTooltipEvent v) {
        if (a(v.getItemStack(), v.qq) && v.getItemStack().hasTagCompound()) {
            ...
            if (v2 != null) {
                ...
                final TileEntity v3 = TileEntity.create((World)v.mc.world, v2);
    ...
    public void a(final RenderTooltipEvent.PostText v) {
        ...
        if (a(v.getStack(), v.qq) && v.getStack().hasTagCompound()) {
            ...
            if (v2 != null) {
                ...
                if (v3 != null && v3.hasCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, (EnumFacing)null)) {
                    ...
                    final ScaledResolution v12 = new ScaledResolution(v.mc);
                    ...
                    v.mc.getTextureManager().bindTexture(v.resourceLocation);
                    ...
                    final RenderItem v16 = v.mc.getRenderItem();
