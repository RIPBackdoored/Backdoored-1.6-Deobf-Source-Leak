...
public class ASMifier extends Printer
{
    ...
    @Override
    public /* bridge */ Printer visitTryCatchAnnotation(final int typeRef, final TypePath typePath, final String desc, final boolean visible) {
        return this.visitTryCatchAnnotation(typeRef, typePath, desc, visible);
    }
    
    @Override
    public /* bridge */ Printer visitInsnAnnotation(final int typeRef, final TypePath typePath, final String desc, final boolean visible) {
        return this.visitInsnAnnotation(typeRef, typePath, desc, visible);
    }
    
    @Override
    public /* bridge */ Printer visitParameterAnnotation(final int parameter, final String desc, final boolean visible) {
        return this.visitParameterAnnotation(parameter, desc, visible);
    }
    
    @Override
    public /* bridge */ Printer visitMethodTypeAnnotation(final int typeRef, final TypePath typePath, final String desc, final boolean visible) {
        return this.visitMethodTypeAnnotation(typeRef, typePath, desc, visible);
    }
    
    @Override
    public /* bridge */ Printer visitMethodAnnotation(final String desc, final boolean visible) {
        return this.visitMethodAnnotation(desc, visible);
    }
    ...
    @Override
    public /* bridge */ Printer visitFieldTypeAnnotation(final int typeRef, final TypePath typePath, final String desc, final boolean visible) {
        return this.visitFieldTypeAnnotation(typeRef, typePath, desc, visible);
    }
    
    @Override
    public /* bridge */ Printer visitFieldAnnotation(final String desc, final boolean visible) {
        return this.visitFieldAnnotation(desc, visible);
    }
    
    @Override
    public /* bridge */ Printer visitArray(final String name) {
        return this.visitArray(name);
    }
    
    @Override
    public /* bridge */ Printer visitAnnotation(final String name, final String desc) {
        return this.visitAnnotation(name, desc);
    }
    
    @Override
    public /* bridge */ Printer visitMethod(final int access, final String name, final String desc, final String signature, final String[] exceptions) {
        return this.visitMethod(access, name, desc, signature, exceptions);
    }
    
    @Override
    public /* bridge */ Printer visitField(final int access, final String name, final String desc, final String signature, final Object value) {
        return this.visitField(access, name, desc, signature, value);
    }
    
    @Override
    public /* bridge */ Printer visitClassTypeAnnotation(final int typeRef, final TypePath typePath, final String desc, final boolean visible) {
        return this.visitClassTypeAnnotation(typeRef, typePath, desc, visible);
    }
    
    @Override
    public /* bridge */ Printer visitClassAnnotation(final String desc, final boolean visible) {
        return this.visitClassAnnotation(desc, visible);
    }
}
