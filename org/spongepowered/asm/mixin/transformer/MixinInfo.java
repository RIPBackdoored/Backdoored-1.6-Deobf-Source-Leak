...
class MixinInfo implements Comparable<MixinInfo>, IMixinInfo
{
    ...
    @Override
    public /* bridge */ ClassNode getClassNode(final int flags) {
        return this.getClassNode(flags);
    }
    ...
    class MixinMethodNode extends MethodNode
    {
        ...
        public MixinMethodNode(final MixinInfo this$0, final int access, final String name, final String desc, final String signature, final String[] exceptions) {
            this.this$0 = this$0;
